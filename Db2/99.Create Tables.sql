...
CREATE TABLE DB2ADMIN.NATION (
    ...
    FOREIGN KEY (N_REGIONKEY) REFERENCES DB2ADMIN.REGION(R_REGIONKEY)
) IN LOOKUP_TS
  INDEX IN LOOKUP_IDX_TS
  ORGANIZE BY ROW
  COMPRESS NO;
...
CREATE INDEX IDX_CUSTOMER_NATION ON DB2ADMIN.CUSTOMER(C_NATIONKEY);
CREATE INDEX IDX_SUPPLIER_NATION ON DB2ADMIN.SUPPLIER(S_NATIONKEY);
CREATE INDEX IDX_ORDERS_CUSTOMER ON DB2ADMIN.ORDERS(O_CUSTKEY);
CREATE INDEX IDX_LINEITEM_ORDER ON DB2ADMIN.LINEITEM(L_ORDERKEY);
CREATE INDEX IDX_LINEITEM_PART_SUPP ON DB2ADMIN.LINEITEM(L_PARTKEY, L_SUPPKEY);
CREATE INDEX IDX_NATION_REGION ON DB2ADMIN.NATION(N_REGIONKEY);